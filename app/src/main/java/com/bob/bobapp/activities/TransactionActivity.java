...
public class TransactionActivity extends BaseFragment implements onSortItemListener {
    ...
    private String strDateForRequest = "", searchKey = "", status = "1", dateTime = "", currentYear, currentMonth, currentDay, finalBusinessDate, sipDate = "";
    ...
    public void getIds(View view) {
        ...
        String[] arrayBusinessString = businessDate.split("T");

        String fromDate = arrayBusinessString[0];

        String[] arrayStrings = fromDate.split("-");

        String arrayYear = arrayStrings[0];
        String arrayMonth = arrayStrings[1];
        String arrayDay = arrayStrings[2];

        String finalBusinessDates = arrayYear + "/" + arrayMonth + "/" + arrayDay;
        ...
        Date date = null;
        try {
            date = dt.parse(finalBusinessDates);
        ...
        finalBusinessDate = "" + dt1.format(date);
        ...
        String Day = arrayString[2];

        if (Month.equalsIgnoreCase("01") || Month.equalsIgnoreCase("02") || Month.equalsIgnoreCase("03") || Month.equalsIgnoreCase("04")) {
            if (Day.equalsIgnoreCase("01")) {
                currentYear = String.valueOf(Integer.parseInt(Year) - 1);
            } else {
                currentYear = Year;
            }
        } else {
        ...
        // tvSelectedDate.setText(currentYear+"/04"+"/01"+" "+"To"+" "+finalBusinessDate);

        tvSelectedDate.setText("01" + "-Apr-" + currentYear + " " + "To" + " " + finalBusinessDate);
    }
    ...
    public void initializations() {
        ...
        if (whichActivity.equalsIgnoreCase("TransactionActivity")) {
            BOBActivity.title.setText("Transaction history");
        } else {
...
//            if (status.equalsIgnoreCase("1"))
//            {
//                sipDate = currentYear + "/04" + "/01" + " " + "To" + " " + finalBusinessDate;
//
//            } else {
//                sipDate = sipDate;
//            }
            ...
            //  tvSelectedDate.setText(currentYear+"/Apr"+"/01"+" "+"To"+" "+finalBusinessDate);
