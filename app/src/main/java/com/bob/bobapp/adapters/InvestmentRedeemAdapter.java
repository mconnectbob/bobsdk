...
public class InvestmentRedeemAdapter extends RecyclerView.Adapter<InvestmentRedeemAdapter.ViewHolder> {
    ...
    public InvestmentRedeemAdapter(Context context, ArrayList<InvestmentCartDetailsResponse> investmentCartDetailsResponseArrayList, OnItemDeleteListener OnItemDeleteListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (investmentCartDetailsResponseArrayList.get(position).getTransactionType().equalsIgnoreCase("redeem")) {
            ...
            holder.txtSwitchAccount.setText(formatter.format(Double.parseDouble(investmentCartDetailsResponseArrayList.get(position).getTxnAmountUnit())));
            ...
            if (investmentCartDetailsResponseArrayList.get(position).getAmountOrUnit().equalsIgnoreCase("U") && investmentCartDetailsResponseArrayList.get(position).getAllorPartial().equalsIgnoreCase("A")) {
                holder.txtOrderBasis.setText("Full redemption");
            }
        ...
        holder.imgDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OnItemDeleteListener.onRedeemItemDeleteListener(investmentCartDetailsResponseArrayList.get(position).getICDID(), position, investmentCartDetailsResponseArrayList.get(position).getTxnAmountUnit());
